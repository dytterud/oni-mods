	...
	internal class SpritePatch
	{
		...
		public class Assets_OnPrefabInit_Patch
		{
			...
			public static void Prefix(Assets __instance)
			{
				...
				ModAssets.Gas_Placer_Sprite = InjectionMethods.AddSpriteToAssets(__instance, "BPV2_GasPlacer");
				ModAssets.Liquid_Placer_Sprite = InjectionMethods.AddSpriteToAssets(__instance, "BPV2_LiquidPlacer");
